        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    {{ Form::open(['route' => 'agent.buy.plan.store', 'class' => 'forms-sample', 'method' => 'post']) }}

                    {!! Form::hidden('plan_id', $value = $plan->id) !!}
                    ...
                    <div class="card-body">
                        <div class="container-fluid d-flex justify-content-between">
                            ...
                            <div class="col-lg-3 pe-0">
                                ...
                                <h4 class="text-end fw-normal">$ {{ $plan->plan_amount }}</h4>
                        ...
                        <div class="container-fluid mt-5 d-flex justify-content-center w-100">
                            <div class="table-responsive w-100">
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        <tr class="text-end">
                                            <td class="text-start">{{ $plan->id }}</td>
                                            <td class="text-start">{{ $plan->plan_name }}</td>
                                    ...
                                    <div class="table-responsive">
                                        <table class="table">
                                            <tbody>
                                                <tr>
                                                    <td>Sub Total</td>
                                                    <td class="text-end">$ {{ $plan->plan_amount }}</td>
                                                </tr>

                                                <tr>
                                                    <td class="text-bold-800">Total</td>
                                                    <td class="text-bold-800 text-end"> $ {{ $plan->plan_amount }}</td>
                                                </tr>
                                                <tr>
                                                    <td>Payment Made</td>
                                                    <td class="text-danger text-end">(-) $ {{ $plan->plan_amount }}
                                                    </td>
                                                </tr>
                                                <tr class="bg-dark">
                        ...
                        <div class="container-fluid w-100">
                            ...
                            <button type="submit" class="btn btn-primary float-end mt-4 mb-3 ms-2"><i data-feather="send"
